class MyXMLReader {
    ...
    obtenerNodo(nombreNodo) {
        ...
        var xml = new File("./wikihades.xml");
        console.log(xml);*/
    }
    ...
    dibujarMapa() {
        ...
        var mapaOriginal = new google.maps.Map(document.getElementById('mapa'), {
            zoom: 8,
            center: gijon
        });
        this.marcadores.forEach(element => {
            ...
            element.forEach(coord => {
                if (coord != "" && coord != undefined && coord != null) {
                    ...
                    var coordenada = {
                        lat: parseFloat(parsedCoordenada[1]),
                        lng: parseFloat(parsedCoordenada[0])
                    }
